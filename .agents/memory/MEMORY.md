...
- [CLIP embedding integration](clip-embedding-integration.md) — additive second-pass signal on top of hash pipeline; weights, file layout, graceful fallback rules.
